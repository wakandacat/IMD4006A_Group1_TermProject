...
public class rumbleBehavior : MonoBehaviour
{
    ...
    public IEnumerator rumble()
    {
        ...
        while (true)
        {
            ...
            else if (playBreak == true && triggerVal_L >= 0.01f) //means you're holding an item that can break
            {
                //trigger is being held
                //if (triggerVal_L >= 0.1f)
                //{
            ...
            {
                //should kill if digging is false and no breakable item is held
                gamepad.SetMotorSpeeds(0.0f, 0.0f);
            }
